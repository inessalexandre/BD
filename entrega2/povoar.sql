...
insert into Ator(nome, dataDeNascimento, papel) values ('Tobey Maguire', '1975-06-27', 'SECUNDARIO');

/*Realizador(idRealizador, nome, dataDeNascimento)*/

insert into Realizador(nome, dataDeNascimento) values ('Roberto Benigni', '1952-10-27');
insert into Realizador(nome, dataDeNascimento) values ('Sam Raimi', '1959-10-23');
...
/*Filme(idFilme, nome, dataEstreia, linguagem, duracao, idadeMinima)*/
...
insert into Filme (nome, dataEstreia, linguagem, duracao, idadeMinima) values('Os intocáveis', '1987-10-02', 'INGLES', 1.28, 8);
insert into Filme (nome, dataEstreia, linguagem, duracao, idadeMinima) values('Star Wars - O despertar da força', '2015-12-17', 'INGLES', 2.16, 8);
...
insert into Sala(cinemaId, nDaSala, lotacao) values (4, 1, 53);
...
/*Sessao(SessaoId, horário, diaDaSemana)*/

insert into Sessao(filmeId, salaId, horario, diaDaSemana, dimensao) values (1, 4, '15:00:00', 'SEGUNDA-FEIRA','3d');
insert into Sessao(filmeId, salaId, horario, diaDaSemana, dimensao) values (2, 2, '14:20:00', 'TERCA-FEIRA','3d');
insert into Sessao(filmeId, salaId, horario, diaDaSemana, dimensao) values (3, 1, '09:20:00', 'QUARTA-FEIRA','3d');
insert into Sessao(filmeId, salaId, horario, diaDaSemana, dimensao) values (4, 7, '10:20:00', 'QUINTA-FEIRA','3d');
insert into Sessao(filmeId, salaId, horario, diaDaSemana, dimensao) values (5, 9, '19:30:00', 'SEXTA-FEIRA','3d');
insert into Sessao(filmeId, salaId, horario, diaDaSemana, dimensao) values (6, 3, '10:20:00', 'SABADO','2d');
insert into Sessao(filmeId, salaId, horario, diaDaSemana, dimensao) values (7, 10, '18:00:00', 'DOMINGO','2d');
insert into Sessao(filmeId, salaId, horario, diaDaSemana, dimensao) values (8, 6, '15:00:00', 'SEGUNDA-FEIRA','2d');
insert into Sessao(filmeId, salaId, horario, diaDaSemana, dimensao) values (9, 8, '14:20:00', 'TERCA-FEIRA','2d');
insert into Sessao(filmeId, salaId, horario, diaDaSemana, dimensao) values (10, 5, '09:20:00', 'QUARTA-FEIRA','2d');

/*Bilhete(clienteId, sessaoId, preco, nAssento)*/

insert into Bilhete(clienteId, sessaoId, preco, nAssento) values (1,1, 10.5, 69);
insert into Bilhete(clienteId, sessaoId, preco, nAssento) values (1,1, 10.5, 69);
insert into Bilhete(clienteId, sessaoId, preco, nAssento) values (2,3, 10.5, 69);
insert into Bilhete(clienteId, sessaoId, preco, nAssento) values (1,1, 10.5, 69);
insert into Bilhete(clienteId, sessaoId, preco, nAssento) values (1,1, 10.5, 69);
insert into Bilhete(clienteId, sessaoId, preco, nAssento) values (1,1, 10.5, 69);
insert into Bilhete(clienteId, sessaoId, preco, nAssento) values (1,1, 10.5, 69);
